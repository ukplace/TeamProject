				...
				<div class="row">
					<div class="col">
						<div class="breadcrumbs-img"
							style="background-image: url(${pageContext.request.contextPath}/images/kids8.jpg);">
							<h2>KID'S</h2>
						</div>
							...
							<ul>
								<li class="active"><c:choose>
										<c:when test="${pageDTO.startPage > pageDTO.pageBlock }">
											<a
												href="${pageContext.request.contextPath}/foot/list_kids?pageNum=${pageDTO.startPage-pageDTO.pageBlock}"><i
								...
								<li class="active"><c:forEach var="i"
										...
										step="1">
										<a
											href="${pageContext.request.contextPath}/foot/list_kids?pageNum=${i }"
											${1 }>${i }</a>
									</c:forEach></li>
								...
								<li class="active">
									<!-- end페이지가 count보다 더 클때 --> <c:choose>
										<c:when test="${pageDTO.endPage > pageDTO.pageCount }">
											<a
												href="${pageContext.request.contextPath}/foot/list_kids?pageNum=${pageDTO.startPage+pageDTO.pageBlock}">다음<i

			...
			<div class="row">
				...
				<div class="col-lg-8">
					<form method="post" class="colorlib-form" name="join"
						action="${pageContext.request.contextPath}/center/notice_update_pro?notice_idx=${noticeDTO.notice_idx}">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="col-md-9">
							...
							<div class="form-group">
								...
								<div class="form-group">
									<label for="tel"><h4>공지사항 제목</h4></label> <input type="text"
										id="notice_subject" name="notice_subject" class="subject"
										value="${noticeDTO.notice_subject }">
								</div>

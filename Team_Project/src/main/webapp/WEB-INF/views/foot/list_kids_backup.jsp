					...
					<div class="col-sm-4 text-center">
						<div class="featured">
							<div class="featured-img featured-img-2"
								...
								<h2>Kids</h2>
								<p>
									<a href="${pageContext.request.contextPath}/foot/list_kids_kid"
					...
					<div class="col-sm-4 text-center">
						<div class="featured">
							<div class="featured-img featured-img-2"
								...
								<p>
									<a
										href="${pageContext.request.contextPath}/foot/list_kids_running"
										class="btn btn-primary btn-lg">Shop now</a>
								</p>
							</div>
						</div>
					...
					<div class="col-sm-4 text-center">
						<div class="featured">
							<div class="featured-img featured-img-2"
								...
								<p>
									<a
										href="${pageContext.request.contextPath}/foot/list_kids_sneakers"
										class="btn btn-primary btn-lg">Shop now</a>
								</p>
							</div>
						</div>
							...
							<div class="col-md-12 text-center">
								...
								<div class="block-27">
									<ul>
										...
										<li><a
											href="${pageContext.request.contextPath}/admin/product_list?pageNum=${pageDTO.startPage - pageDTO.pageBlock}"><i
										...
										<c:forEach var="i" begin="${pageDTO.startPage }"
											...
											<li class="active"
												onclick="location.href='${pageContext.request.contextPath}/admin/product_list?pageNum=${i}"><span>${i}</span></li>
										</c:forEach>

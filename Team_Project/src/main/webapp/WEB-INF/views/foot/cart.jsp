	...
	<div id="page">
		...
		<div class="colorlib-product">
			<div class="container">
				...
				<form action="${pageContext.request.contextPath}/foot/Cart_order"
					method="post" name="cart" id="cart">
								...
								<div class="product-cart d-flex">
									<div class="one-forth">
										<div class="product-img">
											<img
												src="${pageContext.request.contextPath}${cartListDTO.p_thumImg}"
									...
									<div class="one-eight text-center">
										<div class="display-tc">
											<input type="hidden" name=cart${status.index}
												value="${cartListDTO.cart_idx }"> <input
												type="button" class="closed" id="closed"
												onclick="deleteCart(cart${status.index})">
										</div>
									</div>
								</div>
								<c:set var="sum"
							...
							<div class="col-sm-4 text-center" id="ttp">
								<div class="total">
									<div class="sub">
										<p>
											<span>Subtotal:</span> <span><fmt:formatNumber
													pattern="###,###,###" value="${sum}" />원</span>
										</p>
										<p>
											<span>Delivery:</span> <span> <c:set var="Delivery"
													value="0" /> <c:choose>
									...
									<div class="grand-total">
										<p>
											<span><strong>Total:</strong></span> <span> <fmt:formatNumber
													pattern="###,###,###" value="${Delivery+sum }" />원
											</span>
										</p>

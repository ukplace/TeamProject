			...
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread">
							<span><a
								href="${pageContext.request.contextPath}/foot/join">회원가입</a></span> / <span>로그인</span>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<form method="post" class="colorlib-form"
						action="${pageContext.request.contextPath}/foot/loginPro">
						<h2>로그인</h2>
						<div class="row">
							<div class="col-md-12">
							...
							<div class="col-md-7">
								...
								<div class="form-group">
									<input class="form-control" placeholder="E-mail" name="m_email"
										type="email" autofocus>
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="Password"
										name="m_pass" type="password" value="">
								</div>
								<div class="checkbox">
									&nbsp; &nbsp; &nbsp;&nbsp;<input name="remember"
										type="checkbox" value="Remember Me">로그인 정보 저장<br>
									<br> <input type="submit" class="btn btn-default"
										value=" 로그인">&nbsp; &nbsp; <input type="button"
										class="btn btn-default" value="회원가입"
										onclick="location.href='${pageContext.request.contextPath}/foot/join'">

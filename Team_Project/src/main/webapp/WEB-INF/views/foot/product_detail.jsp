...
<body>
	...
	<div id="page">
		...
		<form action="${pageContext.request.contextPath}/foot/Direct_order"
			method="post" class="order_form" name="Direct_order"
			onsubmit="return buy()">
			<!-- 주문 form -->
			<input type="hidden" id="p_num" name="p_num"
				value="${ProductDTO.p_num}" />
					...
					<div class="row row-pb-lg product-detail-wrap">
							...
							<div class="owl-carousel">
								<div class="item">
									<div class="product-entry border">
										<a href="#" class="prod-img"> <img alt="product_img"
											src="${pageContext.request.contextPath}${ProductDTO.p_img}"
						...
						<div class="col-sm-4">
							<div class="product-desc">
								...
								<br> <br>
								<p class="price">
									<span><fmt:formatNumber value="${ProductDTO.p_price}"
											pattern="#,###,###" /> </span>
								</p>
								...
								<div class="size-wrap">
									<div class="block-26 mb-2">
										<h4>Size</h4>
										<p>
											<input type="hidden" name="p_size" id="p_size"> <select
												name="selectBox" id="selectBox"
												onchange="selectSize(this.value)">
...
// 								alert("select값 : " + selectValue);
								...
								<div class="input-group mb-4">
									...
									<p class="addToCart">
										<button type="button" class="addCart_btn" id="addCartBtn"
											value="cartBtn">add to cart</button>
										<script
											src="${pageContext.request.contextPath}/resources/script/jquery-3.6.0.js"></script>
										<script>
...
// 							     alert("카트 담기 실패");
									...
									&emsp; <input type="submit" id="buyBtn" class="buyBtn"
										style="height: 40px" value="Buy">
					...
					<div class="bd-example bd-example-tabs">
						<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
							...
							<li class="nav-item"><a class="nav-link active"
								...
								aria-controls="pills-description" aria-expanded="true">제품리뷰</a>
							</li>
							<!-- 								    <li class="nav-item"> -->
							...
							<li class="nav-item"><a class="nav-link" id="review"
								...
								aria-controls="pills-review" aria-expanded="true">상세보기</a></li>
							...
							<div class="table" style="text-align: center;">
								<div class="tab-content" id="pills-tabContent">
									<div class="tab-pane border fade show active"
										...
										<p
											style="font-size: 30x; text-align: center; margin: 0 auto; padding-bottom: 5px;">제품
											리뷰 보기</p>

				...
				<div class="row">
					<div class="col-sm-12">
						<div class="contact-wrap">
							...
							<form
								action="${pageContext.request.contextPath}/foot/reviewUpdatePro"
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="product">제품명</label> <input type="text"
												id="product" class="form-control" placeholder="제품명" readonly>
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-sm-12">
										<div class="form-group">
											<label for="subject">제목</label> <input type="text"
												id="subject" class="form-control" placeholder="리뷰 제목을 적어주세요">
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-sm-12">
										<div class="form-group">
											...
											<textarea name="content" id="content" cols="30" rows="10"
												class="form-control" placeholder="리뷰 내용을 적어주세요"></textarea>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="form-field">
												<i class="icon icon-arrow-down3"></i> <select
													name="cost_score" id="cost_score" class="form-control">
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="form-field">
												<i class="icon icon-arrow-down3"></i> <select
													name="quality_score" id="quality_score"
													class="form-control">
													<option value="0">평점을 선택해주세요</option>
													<option value="1">★★★★★</option>
													<option value="2">★★★★</option>
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="form-field">
												<i class="icon icon-arrow-down3"></i> <select
													name="design_score" id="design_score" class="form-control">
													<option value="0">평점을 선택해주세요</option>
													<option value="1">★★★★★</option>
													<option value="2">★★★★</option>
													<option value="3">★★★</option>
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<a href="index"><button type="submit"
													class="btn btn-primary">리뷰 수정</button></a>

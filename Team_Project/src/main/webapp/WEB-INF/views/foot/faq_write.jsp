	...
	<div id="page">
		...
		<div class="row">
			<div class="col-lg-8" style="display: inline-block; margin: 0 auto;">
				<form
					action="${pageContext.request.contextPath}/center/faq_write_pro"
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea name="faq_answer" id="content" cols="50" rows="10"
								class="form-control-9" placeholder="내용을 적어주세요"></textarea>

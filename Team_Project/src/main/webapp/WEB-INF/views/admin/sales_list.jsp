								...
								<div class="panel-body" align="center">
									<c:if test="${pageDTO.startPage > pageDTO.pageBlock }">
										<button type="button" class="btn btn-default"
											onclick="location.href='${pageContext.request.contextPath}/admin/sales_list?pageNum=${pageDTO.startPage - pageDTO.pageBlock}'">
											Prev</button>
									</c:if>
									...
									<c:forEach var="i" begin="${pageDTO.startPage }"
										...
										<button type="button" class="btn btn-default"
											onclick="location.href='${pageContext.request.contextPath}/admin/sales_list?pageNum=${i}'">
											${i}</button>
									</c:forEach>

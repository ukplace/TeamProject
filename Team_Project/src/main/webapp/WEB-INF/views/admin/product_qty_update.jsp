			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<form
							action="${pageContext.request.contextPath}/admin/product_qty_insertPro"
							method="post" name="updateForm2" id="updateForm2">
							...
							<table>
								...
								<tr>
									<th>재고</th>
									<td><input type="text" name="list[0].p_stock" width=40px
										padding=6px margin=100px placeholder="재고수량입력" value="">
									</td>
								</tr>
								...
								<tr>
									<th>재고</th>
									<td><input type="text" name="list[1].p_stock" width=40px
										padding=6px margin=100px placeholder="재고수량입력"></td>
								</tr>
								<tr>
									<th>사이즈</th>
								...
								<tr>
									<th>재고</th>
									<td><input type="text" name="list[2].p_stock" width=40px
										padding=6px margin=100px placeholder="재고수량입력" value="">
									</td>
								</tr>

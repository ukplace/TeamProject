			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<form
							action="${pageContext.request.contextPath }/admin/product_regist_pro"
									...
									<table>
										...
										<tr>
											...
											<td><input type="text" name="p_small_category"
												required="required" size="20" value="${selectValue }"></td>
										</tr>
										<tr>
											<th>제품명</th>
										...
										<tr>
											...
											<td><input type="text" name="p_price" width=40px
												padding=6px margin=100px placeholder="제품가격입력"></td>
										</tr>
										...
										<tr>
											...
											<td><input type="text" name="p_color" width=40px
												padding=6px margin=100px placeholder="제품색상입력"></td>
										</tr>
										...
										<tr>
											<th>제품 설명</th>
											<td><textarea rows="20" cols="41" name="p_explain"></textarea>
											</td>
										</tr>

										<tr>
											<td colspan="2" align="center"><input type="submit"
												class="btn btn-default" value="등록"> <input
												type="reset" class="btn btn-default" value="취소"></td>
										</tr>

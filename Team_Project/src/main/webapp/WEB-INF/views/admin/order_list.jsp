													...
													<div class="orderMember">
														<td class="center">
															...
															id="o_state${status.index}">
																<option value="0"
																	<c:if test="${Order_memberDTO.o_state eq '0'}">selected</c:if>>결제완료</option>
																<option value="1"
																	<c:if test="${Order_memberDTO.o_state eq '1'}">selected</c:if>>배송준비중</option>
																<option value="2"
																	<c:if test="${Order_memberDTO.o_state eq '2'}">selected</c:if>>배송중</option>
																<option value="3"
																	<c:if test="${Order_memberDTO.o_state eq '3'}">selected</c:if>>배송완료</option>
															...
															value="주문상태 변경" name="chagestate${status.index}"

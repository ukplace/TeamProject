							...
							<a href="#">
								<div class="panel-footer">
									<span class="pull-left"><a
										href="${pageContext.request.contextPath}/admin/product_list">View
					...
					<div class="col-lg-3 col-md-6">
						<div class="panel panel-green">
							...
							<a href="#">
								<div class="panel-footer">
									<span class="pull-left"><a
										href="${pageContext.request.contextPath}/admin/order_list">View
											Details</a></span> <span class="pull-right"><i
										class="fa fa-arrow-circle-right"></i></span>
		...
		var myChart = new Chart(context,
				{
					...
					data : { // 차트에 들어갈 데이터
						...
						//데이터
						{
							...
							borderColor : [
							//경계선 색상
							'rgba(153, 113, 59, 1)', 'rgba(54, 162, 235, 1)',
									'rgba(255, 206, 86, 1)',
									'rgba(75, 192, 192, 1)',
									'rgba(153, 102, 255, 1)',
									'rgba(153, 102, 255, 1)',

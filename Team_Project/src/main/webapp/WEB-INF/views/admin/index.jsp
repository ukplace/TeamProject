                    ...
                    <div class="row">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <a href="#">
                                    <div class="panel-footer">
                                        <span class="pull-left"><a href="${pageContext.request.contextPath}/admin/product_list">View Details</a></span>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-green">
                                ...
                                <a href="#">
                                    <div class="panel-footer">
                                        <span class="pull-left"><a href="${pageContext.request.contextPath}/admin/order_list">View Details</a></span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                ...
                                <div class="panel-footer">
                                    <div class="input-group">
                                        <input id="btn-input" type="text" class="form-control input-sm"
                                               placeholder="Type your message here${pageContext.request.contextPath}."/>

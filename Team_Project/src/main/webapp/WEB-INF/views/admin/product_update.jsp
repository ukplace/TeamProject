...
<!-- review-img-div.css  -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/product-img-div.css">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<form
							action="${pageContext.request.contextPath}/admin/product_update_pro"
							method="post" name="updateForm" enctype="multipart/form-data">

							<input type="hidden" name="p_num" value="${ProductDTO.p_num}" />

							<table class="table-ca" width=60% tyletable-layout:fixed
								cellspacing=() cellpadding=1;>
								<tr>
									<td width=30% id=td1 align="center">
										<h1>대 분 류</h1>
									</td>
									<td class="space"></td>
									<td width=30% id=td2 align="center">
										<h1>소 분 류</h1>
									</td>
								</tr>
								<tr>
									<td><select name="mainCategory" size=10
										style="width: 100%" onchange="changeCa1(this.value)">
									</select></td>
									<td class="space"></td>
									<td><select name="subCategory" size=10 style="width: 100%"
										value="${selectValue }" onchange="changeCa(this.value)">
									</select></td>
								</tr>
							</table>
							...
							<div class="main">
								<div class=table-regist>
									...
									<table>
										...
										<tr>
											<th>카테고리-대분류</th>
											<td><input type="text" name="p_category"
												required="required" size="20"
												value="${ProductDTO.p_category}"></td>
										</tr>
										<tr>
											<th>카테고리-소분류</th>
											<td><input type="text" name="p_small_category"
												required="required" size="20"
												value="${ProductDTO.p_small_category}"></td>
										</tr>
										<tr>
											<th>제품명</th>
											<td><input type="text" name="p_name" required="required"
												size="20" value="${ProductDTO.p_name}"></td>

										</tr>
										<!-- 제품가격 -->
										<tr>
											<th>제품 가격</th>
											<td><input type="text" name="p_price" width=40px
												padding=6px margin=100px placeholder="제품가격입력"
										...
										<tr>
											<th>제품 색상</th>
											<td><input type="text" name="p_color" width=40px
												padding=6px margin=100px placeholder="제품색상입력"
												value="${ProductDTO.p_color}"></td>
										</tr>


										<tr>
											<th rowspan="2">대표 사진</th>
											<td><input type="file" id="p_img" name="file" width=40px
												value="사진등록" required="required" /></td>
										</tr>
										...
										<tr>
											<th>제품 설명</th>
											<td><textarea rows="20" cols="41" name="p_explain">${ProductDTO.p_explain}</textarea>
											</td>
										</tr>
                        ...
                        <!-- /.col-lg-12 -->
												...
												<!-- Custom Theme JavaScript --> <script
													src="${pageContext.request.contextPath}/js/startmin.js"></script>

   ...
   <table class="table-ca" width=60% tyletable-layout:fixed cellspacing=() cellpadding=1;>                 
	...
	<div class=table-regist>
      ...
      <!-- 제품명 -->
	      <tr>
			<th>카테고리-대분류</th>
			<td><input type="text" name="p_category" required="required" size="20" value="<% %>"></td>
		 </tr>
		 <tr>
			<th>카테고리-소분류</th>
			<td><input type="text" name="p_small_category" required="required" size="20" value="<% %>" ></td>
		 </tr>
		  <tr>
      		<th>제품명</th>
      		<td><input type="text" name="p_name" required="required" size="20" value="<% %>"></td>
      ...
      <th>재고</th>
      	<td>
      	  <input type="text" name="p_stock" width = 40px padding= 6px  margin= 100px  placeholder="재고수량입력" value="<% %>">
      	</td>
      	</tr>
      <!-- 제품가격 -->
      <tr>
      <th>제품 가격</th>
      <td>
      	<input type="text" name="p_price" width = 40px padding= 6px margin= 100px placeholder="제품가격입력" value="<% %>">
	 </td>
	 </tr>	
				...
				<tr>
					<th>색상</th>
					<td>
						<input type="text" name="p_color" required="required" size="10" value="<% %>">
			...
			<tr>
				<th>사이즈</th>
					<td>
						<input type="text" name="p_size" required="required" size="10" value="<% %>">
...
<!-- 					</tr> -->
				...
				<th>제품 설명</th>
					<td>
						<textarea rows="20" cols="41" name="p_explain" value="<% %>"></textarea>
					</td>
				</tr>
...
$(function(){
	$('#btn-remove').click(function(){
		if(confirm("삭제하시겠습니까?")){
			self.location.href = "${pageContext.request.contextPath}/admin/product_update?num=${productDTO.p_num}";
		}
	});
});
